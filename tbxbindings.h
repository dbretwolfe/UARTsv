...
int tbx_set_api(const char *file, int line, const char *signal_name, svLogicVecVal *signal_value); 
int tbx_force_api(const char *file, int line, const char *signal_name, svLogicVecVal *signal_value); 
